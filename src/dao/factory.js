...
switch (config.PERSISTENCE) {
    case "MONGO":
        ...
        TicketDao = await import("./mongo/ticket.mongo.dao.js").then(module => module.default)
    ...
    case "FS":
        ...
        TicketDao = await import("./fs/ticket.fs.dao.js").then(module => module.default)
    ...
    case "MEMORY":
        ...
        TicketDao = await import("./memory/ticket.mem.dao.js").then(module => module.default)
